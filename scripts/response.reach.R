...
alloutputs=function(){
make.outputs(mydata, poolby="", OUTdir, myfacet="ROI", RSlevels)
make.outputs(mydata, poolby="RS", OUTdir,myfacet="ROI", RSlevels)
make.outputs(mydata, poolby="RScond", OUTdir,myfacet="ROI",RSlevels)
}
